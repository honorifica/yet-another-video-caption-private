...
def parse_opts():
    ...
    parser.add_argument('--input', default='c3d/input', type=str, help='Input file path')
    parser.add_argument('--video_root', default='./videos', type=str, help='Root path of input videos')
    parser.add_argument('--model', default='c3d/resnet-34-kinetics.pth', type=str, help='Model file path')
